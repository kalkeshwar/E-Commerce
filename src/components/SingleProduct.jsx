...
import {  faIndianRupeeSign, faStar, faStarHalf, faStarHalfAlt } from '@fortawesome/free-solid-svg-icons'
...
const SingleProduct = () => {
    ...
    const handleCart =(product)=>{
        ...
        user?dispatch(addToCart(productInfo)):toast.error("Please signIn")
    }
            ...
            {!isLoading && !iserror && (
                <Container>
                    ...
                    <Info>
                        ...
                        <Price><FontAwesomeIcon icon={faIndianRupeeSign} />{productdetails.price}</Price>
                        <Quantwrapper>
